...
LINKAREER_MAX_PAGES = int(os.getenv("LINKAREER_MAX_PAGES", "5"))
WEVITY_MAX_PAGES = int(os.getenv("WEVITY_MAX_PAGES", "3"))
WEVITY_MAX_CATEGORIES = int(os.getenv("WEVITY_MAX_CATEGORIES", "3"))
THINKGOOD_MAX_PAGES = int(os.getenv("THINKGOOD_MAX_PAGES", "5"))
